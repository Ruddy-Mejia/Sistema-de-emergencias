            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <button class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img src="{{ URL::asset('/assets/images/flags/bo.png') }}" class="rounded"
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{ Auth::user()->rol }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <h6 class="dropdown-header">Bienvenido {{ Auth::user()->name }}!</h6>
                        <a class="dropdown-item" href="{{ route('users.show', ['user' => Auth::user()->id]) }}"><i
