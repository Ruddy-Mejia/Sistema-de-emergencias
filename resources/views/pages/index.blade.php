                ...
                <div class="card-body">
                    <div id="customerList">
                        ...
                        <div class="table-responsive table-card mt-3 mb-1">
                            <table class="table align-middle table-nowrap" id="datatable">
                                ...
                                <tbody id="tableBody">
                                    @foreach ($pages as $key => $page)
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <button class="btn btn-sm btn-info edit-item-btn"
                                                            ...
                                                            data-bs-target="#showmodal{{ $page->id }}">Ver</button>
                                                    </div>
                                                    <div class="edit">
                                                        <button class="btn btn-sm btn-success edit-item-btn"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#editmodal{{ $page->id }}">Editar</button>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#deletemodal{{ $page->id }}">Eliminar</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        @if (canAccessPage(auth()->user()->role, 'pages.destroy'))
                                        {{-- delete modal --}}
                                        <div class="modal fade zoomIn" id="deletemodal{{ $page->id }}" tabindex="-1"
                                            aria-hidden="true">
                                        ...
                                        @else
                                            <div class="modal fade zoomIn" id="deletemodal{{ $page->id }}"
                                        ...
                                        @endif
                                        {{-- edit modal --}}
                                        @if (canAccessPage(auth()->user()->role, 'pages.edit'))
                                        <div class="modal fade" id="editmodal{{ $page->id }}" tabindex="-2"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form action="{{ route('pages.update', ['page' => $page->id]) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea type="text" class="form-control" name="description" required rows="1">{{ $page->description }}</textarea>
                                                                <div class="invalid-feedback">
                                                                    Por favor, rellene este campo.
                                                                </div>
                                                            </div>
                                        ...
                                        @else
                                            <div class="modal fade zoomIn" id="editmodal{{ $page->id }}"
                                                tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                        ...
                                        @endif
                                        {{-- show modal --}}
                                        @if (canAccessPage(auth()->user()->role, 'pages.show'))
                                        <div class="modal fade" id="showmodal{{ $page->id }}" tabindex="-2"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-light p-3">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="name"
                                                                value="{{ $page->created_at->format('d/m/Y') }}" readonly />
                                                            <div class="invalid-feedback">
                                                                Por favor, rellene este campo.
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="customername-field"
                                                                class="form-label">Descripción</label>
                                                            <textarea type="text" class="form-control" name="description" readonly rows="1">{{ $page->description }}</textarea>
                                                            <div class="invalid-feedback">
                                                                Por favor, rellene este campo.
                                                            </div>
                                                        </div>
                                        ...
                                        @else
                                            <div class="modal fade zoomIn" id="showmodal{{ $page->id }}"
                                                tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                            ...
                            @if (canAccessPage(auth()->user()->role, 'pages.create'))
                            {{-- create modal --}}
