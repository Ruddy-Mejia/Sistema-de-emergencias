...
@section('content')
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
        <div class="row g-4">
            ...
            <div class="col">
                <div class="p-2">
                    <h3 class="text-white mb-1">{{ Auth::user()->name }} {{Auth::user()->last_name }}</h3>
                    <p class="text-white-75">{{ Auth::user()->type }}</p>
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i
                                class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>{{ Auth::user()->address }}</div>
                        <div><i class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{{ Auth::user()->city }}
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link fs-14 active" data-bs-toggle="tab" href="#overview-tab" role="tab">
                                <i class="ri-airplay-fill d-inline-block d-md-none"></i> <span
                                    class="d-none d-md-inline-block">Descripción general</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link fs-14" data-bs-toggle="tab" href="#projects" role="tab">
                                <i class="ri-price-tag-line d-inline-block d-md-none"></i> <span
                                    class="d-none d-md-inline-block">Proyectos</span>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-pane active" id="overview-tab" role="tabpanel">
                        <div class="row">
                            <div class="col-xxl-3">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title mb-5">Completa tu perfil</h5>
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ Auth::user()->name}} {{ Auth::user()->last_name}} {{ Auth::user()->motherlast_name}}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Telefono :</th>
                                                        <td class="text-muted">+(591) {{ Auth::user()->phone}}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ Auth::user()->created_at->format('Y-m-d') }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title mb-4">Portafolio</h5>
