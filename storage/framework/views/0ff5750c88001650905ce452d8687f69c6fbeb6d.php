            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="customerList">
                            ...
                            <table class="table align-middle table-nowrap" id="datatable">
                                ...
                                <tbody id="tableBody">
                                    <?php $__currentLoopData = $ambulances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ambulance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="phone"><?php echo e($ambulance->code); ?></td>
                                            <td class="customer_name">
                                                <?php echo e($ambulance->number_plate); ?></td>
                                            <td class="customer_name"><?php echo e($ambulance->conductor->full_name); ?></td>
                                            <td class="customer_name"><?php echo e($ambulance->color); ?></td>
                                            <td class="customer_name"><?php echo e($ambulance->model); ?></td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <button class="btn btn-sm btn-info edit-item-btn"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#showmodal<?php echo e($ambulance->id); ?>">Ver</button>
                                                    </div>
                                                    <div class="edit">
                                                        <button class="btn btn-sm btn-success edit-item-btn"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#editmodal<?php echo e($ambulance->id); ?>">Editar</button>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#deletemodal<?php echo e($ambulance->id); ?>">Eliminar</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php if(canAccessPage(auth()->user()->role, 'ambulance.destroy')): ?>
                                        
                                        <div class="modal fade zoomIn" id="deletemodal<?php echo e($ambulance->id); ?>" tabindex="-1"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?php echo e(route('ambulance.destroy', $ambulance->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                            <div class="modal fade zoomIn" id="deletemodal<?php echo e($ambulance->id); ?>"
                                        ...
                                        <?php endif; ?>
                                        <?php if(canAccessPage(auth()->user()->role, 'ambulance.show')): ?>
                                        
                                        <div class="modal fade" id="showmodal<?php echo e($ambulance->id); ?>" tabindex="-2"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="<?php echo e($ambulance->code); ?>" readonly />
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="customername-field"
                                                                class="form-label">Nombre</label>
                                                            <input type="text" class="form-control"
                                                                value="<?php echo e($ambulance->conductor->full_name); ?>" readonly />
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="customername-field"
                                                                class="form-label">Color</label>
                                                            <input type="text" class="form-control"
                                                                value="<?php echo e($ambulance->color); ?>" readonly />
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="email-field" class="form-label">Modelo</label>
                                                            <input type="text" class="form-control"
                                                                value="<?php echo e($ambulance->model); ?>" readonly />
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="customername-field" class="form-label">Fecha de
                                                                registro</label>
                                                            <input type="text" class="form-control"
                                                                value="<?php echo e($ambulance->created_at->format('d/m/Y')); ?>"
                                                                readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <?php else: ?>
                                            <div class="modal fade zoomIn" id="showmodal<?php echo e($ambulance->id); ?>"
                                                tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                        ...
                                        <?php endif; ?>
                                        <?php if(canAccessPage(auth()->user()->role, 'ambulance.edit')): ?>
                                        
                                        <div class="modal fade" id="editmodal<?php echo e($ambulance->id); ?>" tabindex="-2"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form
                                                        action="<?php echo e(route('ambulance.update', ['ambulance' => $ambulance->id])); ?>"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="number_plate"
                                                                    value="<?php echo e($ambulance->number_plate); ?>" required />
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="conductor_id" class="form-select" required>
                                                                    ...
                                                                    <?php $__currentLoopData = $conductors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conductor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($conductor->id == $ambulance->conductor_id): ?>
                                                                            <option value="<?php echo e($conductor->id); ?>" selected>
                                                                                <?php echo e($conductor->full_name); ?>

                                                                            </option>
                                                                        <?php else: ?>
                                                                            <option value="<?php echo e($conductor->id); ?>">
                                                                                <?php echo e($conductor->full_name); ?>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="color"
                                                                    value="<?php echo e($ambulance->color); ?>" required />
                                                                <div class="invalid-feedback">
                                                                    Por favor, rellene este campo.
                                                                </div>
                                                            </div>
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="model"
                                                                    value="<?php echo e($ambulance->model); ?>" required />
                                                                <div class="invalid-feedback">
                                                                    Por favor, rellene este campo.
                                                                </div>
                                                            </div>
                                        ...
                                        <?php else: ?>
                                            <div class="modal fade zoomIn" id="editmodal<?php echo e($ambulance->id); ?>"
                                                tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                        ...
                        <?php if(canAccessPage(auth()->user()->role, 'ambulance.create')): ?>
                        ...
                        <div class="modal fade" id="createmodal" tabindex="-2" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo e(route('ambulance.store')); ?>" method="POST"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laragon\www\sistememergency\resources\views/ambulance/index.blade.php ENDPATH**/ ?>