...
<?php $__env->startSection('css'); ?>
    <link href="<?php echo e(URL::asset('new_assets/css/customizations.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>
                ...
                <div class="team-list grid-view-filter row">
                    <div id="col">
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card team-box col-item">
                                <div class="team-cover">
                                    <img src="<?php echo e(URL::asset('storage/' . $user->photo)); ?>"
                                        onerror="this.onerror=null; this.src='<?php echo e(URL::asset('new_assets/images/small/img-9.jpg')); ?>';"
                                        alt="" class="img-fluid" />
                                </div>
                            ...
                            <?php if(canAccessPage(auth()->user()->role, 'users.destroy')): ?>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(URL::asset('new_assets/js/pages/team.init.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('new_assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laragon\www\sistememergency\resources\views/users/index.blade.php ENDPATH**/ ?>