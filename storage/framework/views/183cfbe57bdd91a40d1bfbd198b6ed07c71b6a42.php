            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        ...
                        <p class="mt-3 fs-15 fw-medium">Sistema de Gestion de Emergencias</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'test@test.test')); ?>" id="username" name="email" placeholder="Enter username">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">No tienes una cuenta ? <a href="register" class="fw-semibold text-primary text-decoration-underline"> Registrate </a> </p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Desocom Software Development. </p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laragon\www\sistememergency\resources\views/auth/login.blade.php ENDPATH**/ ?>